    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="rounded-lg border-2 border-maple-error/60 bg-maple-error/10 p-4">
            <div className="flex items-start gap-3">
              <AlertTriangle className="mt-0.5 w-5 h-5 flex-shrink-0 text-maple-error" />
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              >
                {uuidCopied ? (
                  <CheckCircle className="w-4 h-4 text-maple-success" />
                ) : (
