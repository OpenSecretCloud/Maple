      ...
      <>
        <DialogHeader>
          <DialogTitle className="text-base flex items-center gap-2">
            <Sparkles className="h-5 w-5 text-[hsl(var(--maple-primary))]" />
            Unlock API Access
          </DialogTitle>
          <DialogDescription>
        ...
        <div className="mt-6 space-y-4">
          <Card className="border-[hsl(var(--maple-primary))]/20 bg-gradient-to-br from-[hsl(var(--maple-primary))]/10 to-[hsl(var(--maple-tertiary))]/10 p-6">
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <div className="rounded-lg bg-[hsl(var(--maple-primary))]/15 p-2">
                  <Zap className="h-5 w-5 text-[hsl(var(--maple-primary))]" />
                </div>
                <div>
              ...
              <div className="flex items-center gap-3">
                <div className="rounded-lg bg-maple-info/15 p-2">
              ...
              <div className="flex items-center gap-3">
                <div className="rounded-lg bg-maple-success/15 p-2">
