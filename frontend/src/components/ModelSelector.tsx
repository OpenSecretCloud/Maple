      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            variant="ghost"
            size="sm"
            className="h-8 gap-1 px-2 text-[hsl(var(--maple-secondary-700))] hover:text-[hsl(var(--maple-secondary-700))] hover:bg-[hsl(var(--maple-primary-container))]"
              ...
              {(["quick", "powerful"] as const).map((key) => {
                ...
                return (
                  <DropdownMenuItem
                    ...
                    } ${requiresUpgrade ? "hover:bg-[hsl(var(--maple-primary-container))] dark:hover:bg-[hsl(var(--maple-primary))]/10" : ""}`}
                    disabled={isDisabled}
                  >
