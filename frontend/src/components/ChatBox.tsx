        ...
        <div className="mb-2">
          ...
          {isSystemPromptExpanded && (
            <textarea
              ...
              rows={2}
              className="w-full p-2 text-sm border border-muted-foreground/20 rounded-md bg-muted/50 placeholder:text-muted-foreground/70 focus:outline-none focus:ring-1 focus:ring-ring resize-none transition-colors break-words"
              style={{
                height: "auto",
                resize: "none",
                overflowY: "auto",
