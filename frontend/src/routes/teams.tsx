...
function TeamsPage() {
  return (
    <>
      ...
      <FullPageMain>
        <MarketingHeader
          title={<span>Confidential AI for <span className="text-[hsl(var(--purple))]">Teams</span></span>}
          subtitle={
            <span>
              Secure, private AI for organizations that value trust. Collaborate with confidence—Maple Teams keeps your data safe, even from us.
            </span>
          }
        />
        ...
        <div className="flex flex-col items-center gap-4 mt-8 mb-12">
          <a
            href="/signup?selected_plan=team"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-light mb-4">
                Why Choose <span className="text-[hsl(var(--purple))] font-medium">Maple Teams?</span>
              </h2>
        ...
        <section className="w-full py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:grid-cols-3">
              <FeatureCard
                icon={Shield}
        ...
        <section className="w-full py-16 dark:bg-[hsl(var(--section-alt))] bg-[hsl(var(--section-alt))]">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a
              href="/pricing?selected_plan=team"
            ...
            <div className="mt-6 text-[hsl(var(--marketing-text-muted))] text-sm">
              Need a larger deployment or have compliance questions? <a href="mailto:team@opensecret.cloud" className="underline hover:text-foreground">Contact us</a> for enterprise options.
            </div>
          </div>
        </section>
      </FullPageMain>
